...
import com.example.doc_schedule.databinding.ViewholderTopDoctorsBinding

class TopDoctorAdapter(val items:MutableList<DoctorsModel>):RecyclerView.Adapter<TopDoctorAdapter.Viewholder>() {
    private var context:Context?=null

    class Viewholder(val binding: ViewholderTopDoctorsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopDoctorAdapter.Viewholder {
        ...
        val binding =
            ViewholderTopDoctorsBinding.inflate(LayoutInflater.from(context), parent, false)
